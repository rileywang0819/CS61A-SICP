...
class VendingMachine:
    ...
    """
    "*** YOUR CODE HERE ***"
    def __init__(self, product: str, price):
    ...
    def vend(self):
        if self.stock == 0:
            interaction = 'Nothing left to vend. Please restock.'
        elif self.balance < self.price:
            interaction = f'Please add ${self.price - self.balance} more funds.'
        elif self.balance > self.price:
            self.stock -= 1
            interaction = f'Here is your {self.product} and ${self.balance - self.price} change.'
            self.balance = 0
        else:
            self.stock -= 1
            interaction = f'Here is your {self.product}.'
        return interaction
