...
def distance(city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    lat_diff = get_lat(city_a) - get_lat(city_b)    # latitude difference
    lon_diff = get_lon(city_a) - get_lon(city_b)    # longtitude difference
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    new_city = make_city('whatever', lat, lon)
    closer_city = min(city_a, city_b, key=lambda city: distance(city, new_city))
